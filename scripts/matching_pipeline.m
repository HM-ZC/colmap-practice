...
for i = 1:length(DATASET_NAMES)
    ...
    DATASET_PATH = ['/home/hmzc/vision_train/homework/local-feature-evaluation/datasets/' DATASET_NAMES{i}];

    % TODO: Change this to where VLFeat is located.
    VLFEAT_PATH = '/home/hmzc/matlab2021b/toolbox/vlfeat-0.9.21';

    % TODO: Change this to where the COLMAP build directory is located.
    COLMAP_PATH = '/home/hmzc/vision_train/homework/colmap/build';
